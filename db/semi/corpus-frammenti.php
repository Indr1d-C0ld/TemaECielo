...
['pianeta', 'sole', 'tradizionale', 'il Sole',
 'Il Sole e\' il luminare del giorno, signore del Leone ed esaltato in Ariete. Nella carta '
 . 'indica il padre, l\'autorita\', la dignita\' e la salute; il luogo in cui si e\' visibili e '
 . 'da cui non ci si puo\' nascondere.', 10, 'sole luminare identita'],

['pianeta', 'sole', 'moderno', 'il centro della coscienza',
 'Il Sole e\' cio\' che sei quando nessuno guarda, e insieme cio\' verso cui tendi. Non e\' il '
...
['pianeta', 'luna', 'tradizionale', 'la Luna',
 'La Luna e\' il luminare della notte, signora del Cancro ed esaltata in Toro. Governa la '
 . 'madre, il corpo, le abitudini e gli umori; muta piu\' in fretta di ogni altro corpo, e con '
 . 'lei mutano gli stati d\'animo.', 10, 'luna luminare corpo abitudine'],

['pianeta', 'luna', 'moderno', 'la vita emotiva',
 'La Luna e\' la parte che reagisce prima di pensare: il bisogno di sentirsi al sicuro, la '
 . 'memoria del corpo, cio\' che si cerca istintivamente quando si e\' stanchi.',
 10, 'luna emozione bisogno sicurezza'],

['pianeta', 'mercurio', 'tradizionale', 'Mercurio',
 'Mercurio governa Gemelli e Vergine, ed e\' esaltato in Vergine. Presiede alla parola, al '
 . 'calcolo, ai viaggi brevi, ai fratelli e a ogni commercio. E\' convertibile: prende la '
 . 'natura del pianeta cui si accosta.', 7, 'mercurio parola mente'],

['pianeta', 'mercurio', 'moderno', 'la facolta\' di mettere in relazione',
 'Mercurio e\' il modo in cui raccogli le informazioni e le colleghi: come impari, come '
 . 'spieghi, che cosa noti e che cosa lasci cadere.', 7, 'mercurio mente linguaggio'],

['pianeta', 'venere', 'tradizionale', 'Venere',
 'Venere e\' il benefico minore, signora di Toro e Bilancia, esaltata in Pesci. Governa '
 . 'l\'amore, l\'ornamento, la musica, i patti e tutto cio\' che concilia.', 7, 'venere amore misura'],

['pianeta', 'venere', 'moderno', 'la facolta\' di dare valore',
 'Venere e\' cio\' che ti attira e cio\' che ti sembra bello: il metro con cui stabilisci che '
...
['pianeta', 'marte', 'tradizionale', 'Marte',
 'Marte e\' il malefico minore, signore di Ariete e Scorpione, esaltato in Capricorno. '
 . 'Governa il ferro, il fuoco, la guerra, la chirurgia e l\'ira; da\' coraggio a chi lo tiene '
 . 'bene e rovina chi lo lascia sciolto.', 8, 'marte forza conflitto'],

['pianeta', 'marte', 'moderno', 'la facolta\' di volere',
 'Marte e\' come ti muovi verso quello che vuoi, e come reagisci quando qualcuno si mette in '
 . 'mezzo. E\' anche il modo in cui dici di no.', 8, 'marte volonta conflitto'],

['pianeta', 'giove', 'tradizionale', 'Giove',
 'Giove e\' il benefico maggiore, signore di Sagittario e Pesci, esaltato in Cancro. Governa '
...
['pianeta', 'giove', 'moderno', 'il bisogno di senso',
 'Giove e\' la spinta ad allargare: capire piu\' di quanto serva, andare piu\' in la\' di dove '
...
['pianeta', 'saturno', 'tradizionale', 'Saturno',
 'Saturno e\' il malefico maggiore, signore di Capricorno e Acquario, esaltato in Bilancia. '
 . 'Governa il tempo, il limite, la vecchiaia, la terra e tutto cio\' che resiste. Nega, ma '
 . 'cio\' che concede dura.', 9, 'saturno limite tempo prova'],

['pianeta', 'saturno', 'moderno', 'la struttura',
 'Saturno e\' dove hai dovuto imparare a fare da solo. Segna il punto in cui la realta\' non '
...
['pianeta', 'urano', 'tradizionale', 'Urano',
 'Urano non appartiene alla tradizione: e\' stato visto nel 1781, dopo Tolomeo e dopo Lilly. '
...
['pianeta', 'urano', 'moderno', 'la spinta a liberarsi',
 'Urano e\' il punto in cui non sopporti che ti si dica come si fa. Dove sta, prima o poi '
...
['pianeta', 'nettuno', 'tradizionale', 'Nettuno',
 'Nettuno, scoperto nel 1846, e\' estraneo alla tradizione antica. Gli si attribuisce la '
...
['pianeta', 'nettuno', 'moderno', 'la porosita\' dei confini',
 'Nettuno e\' dove il confine fra te e il resto si assottiglia: l\'empatia, l\'ispirazione, e '
 . 'anche l\'illusione. Dove sta, e\' difficile vedere le cose come sono — in bene e in male.',
 5, 'nettuno confine illusione'],

['pianeta', 'plutone', 'tradizionale', 'Plutone',
 'Plutone e\' del 1930 e alla tradizione non appartiene affatto. Gli autori moderni gli danno '
 . 'lo Scorpione e lo leggono come cio\' che sta sotto e che prima o poi viene a galla: il '
 . 'potere, la morte, la rigenerazione.', 5, 'plutone potere trasformazione'],

['pianeta', 'plutone', 'moderno', 'la capacita\' di trasformazione',
 'Plutone e\' dove non esistono mezze misure: quello che tocca, o lo cambi o ti cambia. E\' '
 . 'anche il punto in cui si gioca la partita del potere — su di se\' prima che sugli altri.',
...
['segno_modo', 'ariete', 'moderno', 'in Ariete',
 ...
 . 'Comincia bene; finire e\' un\'altra faccenda.', 5, 'ariete fuoco cardinale'],
...
['segno_modo', 'toro', 'moderno', 'in Toro',
 ...
 . 'si sposta. La pazienza e\' la sua qualita\'; l\'inerzia il suo rischio.', 5, 'toro terra fisso'],
...
['segno_modo', 'gemelli', 'moderno', 'in Gemelli',
 'prende la forma dei Gemelli: si muove per curiosita\', tiene aperte piu\' strade, e a volte '
...
['segno_modo', 'cancro', 'moderno', 'in Cancro',
 ...
 . 'sicurezza prima di esporsi. La memoria affettiva qui pesa piu\' dei fatti.', 5, 'cancro acqua cardinale'],
...
['segno_modo', 'bilancia', 'moderno', 'in Bilancia',
 ...
 . 'rimanda la decisione finche\' puo\'.', 5, 'bilancia aria cardinale'],
...
['segno_modo', 'sagittario', 'tradizionale', 'in Sagittario, domicilio di Giove',
 ...
 . 'larga e libera. Guarda lontano e trascura cio\' che ha sotto i piedi.', 5, 'sagittario fuoco mobile'],
...
['segno_modo', 'capricorno', 'moderno', 'in Capricorno',
 'prende la forma del Capricorno: si assume la responsabilita\' anche quando nessuno gliel\'ha '
...
['segno_modo', 'acquario', 'tradizionale', 'in Acquario, domicilio diurno di Saturno',
 ...
 . 'umida secondo alcuni, ma saturnina nella fermezza. Si attiene al principio piu\' che alla '
